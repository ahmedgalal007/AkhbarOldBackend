...
// Type: Akhbar.DBBusiness.AdminEditorBusiness
...
{
  public class AdminEditorBusiness : BaseBusiness.BaseBusiness<AdminEditor>
  {
    public AdminEditorBusiness()
    {
    }

    public AdminEditorBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
