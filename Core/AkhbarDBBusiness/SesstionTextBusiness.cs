...
// Type: Akhbar.DBBusiness.SesstionTextBusiness
...
{
  public class SesstionTextBusiness : BaseBusiness.BaseBusiness<SesstionText>
  {
    public SesstionTextBusiness()
    {
    }

    public SesstionTextBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
