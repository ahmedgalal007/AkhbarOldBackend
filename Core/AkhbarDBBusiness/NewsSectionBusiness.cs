...
// Type: Akhbar.DBBusiness.NewsSectionBusiness
...
{
  public class NewsSectionBusiness : BaseBusiness.BaseBusiness<NewsSection>
  {
    public NewsSectionBusiness()
    {
    }

    public NewsSectionBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
