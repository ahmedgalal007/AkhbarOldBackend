...
// Type: Akhbar.DBBusiness.RelatedNewBusiness
...
{
  public class RelatedNewBusiness : BaseBusiness.BaseBusiness<RelatedNew>
  {
    public RelatedNewBusiness()
    {
    }

    public RelatedNewBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
