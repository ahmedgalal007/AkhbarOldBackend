...
// Type: Akhbar.DBBusiness.NewsTagBusiness
...
{
  public class NewsTagBusiness : BaseBusiness.BaseBusiness<NewsTag>
  {
    public NewsTagBusiness()
    {
    }

    public NewsTagBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
