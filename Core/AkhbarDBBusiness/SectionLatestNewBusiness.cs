...
// Type: Akhbar.DBBusiness.SectionLatestNewBusiness
...
{
  public class SectionLatestNewBusiness : BaseBusiness.BaseBusiness<SectionLatestNew>
  {
    public SectionLatestNewBusiness()
    {
    }

    public SectionLatestNewBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
