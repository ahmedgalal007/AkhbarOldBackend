...
// Type: Akhbar.DBBusiness.ReviewerNewBusiness
...
{
  public class ReviewerNewBusiness : BaseBusiness.BaseBusiness<ReviewerNew>
  {
    public ReviewerNewBusiness()
    {
    }

    public ReviewerNewBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
