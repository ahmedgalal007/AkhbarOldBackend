...
// Type: Akhbar.DBBusiness.News_BylineBusiness
...
{
  public class News_BylineBusiness : BaseBusiness.BaseBusiness<News_Byline>
  {
    public News_BylineBusiness()
    {
    }

    public News_BylineBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
