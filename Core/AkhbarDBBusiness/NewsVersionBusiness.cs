...
// Type: Akhbar.DBBusiness.NewsVersionBusiness
...
{
  public class NewsVersionBusiness : BaseBusiness.BaseBusiness<NewsVersions>
  {
    public NewsVersionBusiness()
    {
    }

    public NewsVersionBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
