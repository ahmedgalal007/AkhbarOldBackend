...
// Type: Akhbar.DBBusiness.EmployeeBusinesss
...
{
  public class EmployeeBusinesss : BaseBusiness.BaseBusiness<Employee>
  {
    public EmployeeBusinesss()
    {
    }

    public EmployeeBusinesss(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
