...
// Type: Akhbar.DBBusiness.UMModulesBusiness
...
{
  public class UMModulesBusiness : BaseBusiness.BaseBusiness<UMModules>
  {
    public UMModulesBusiness()
    {
    }

    public UMModulesBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
