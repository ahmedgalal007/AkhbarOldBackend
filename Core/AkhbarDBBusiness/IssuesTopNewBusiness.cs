...
// Type: Akhbar.DBBusiness.IssuesTopNewBusiness
...
{
  public class IssuesTopNewBusiness : BaseBusiness.BaseBusiness<IssuesTopNew>
  {
    public IssuesTopNewBusiness()
    {
    }

    public IssuesTopNewBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
