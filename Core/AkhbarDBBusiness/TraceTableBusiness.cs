...
// Type: Akhbar.DBBusiness.TraceTableBusiness
...
{
  public class TraceTableBusiness : BaseBusiness.BaseBusiness<TraceTable>
  {
    public TraceTableBusiness()
    {
    }

    public TraceTableBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
