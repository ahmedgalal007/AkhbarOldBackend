...
// Type: Akhbar.DBBusiness.TopNewsBusiness
...
{
  public class TopNewsBusiness : BaseBusiness.BaseBusiness<TopNews>
  {
    public TopNewsBusiness()
    {
    }

    public TopNewsBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
