...
// Type: Akhbar.DBBusiness.NewsViewBusiness
...
{
  public class NewsViewBusiness : BaseBusiness.BaseBusiness<NewsView>
  {
    public NewsViewBusiness()
    {
    }

    public NewsViewBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
