...
// Type: Akhbar.DBBusiness.PollsBusiness
...
{
  public class PollsBusiness : BaseBusiness.BaseBusiness<Polls>
  {
    public PollsBusiness()
    {
    }

    public PollsBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
