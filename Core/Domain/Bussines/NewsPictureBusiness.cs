...
// Type: Akhbar.DBBusiness.NewsPictureBusiness
...
{
  public class NewsPictureBusiness : BaseBusiness.BaseBusiness<NewsPictures>
  {
    public NewsPictureBusiness()
    {
    }

    public NewsPictureBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
