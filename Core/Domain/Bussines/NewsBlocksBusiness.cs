...
// Type: Akhbar.DBBusiness.NewsBlocksBusiness
...
{
  public class NewsBlocksBusiness : BaseBusiness.BaseBusiness<NewsBlocks>
  {
    public NewsBlocksBusiness()
    {
    }

    public NewsBlocksBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
