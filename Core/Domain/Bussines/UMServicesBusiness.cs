...
// Type: Akhbar.DBBusiness.UMServicesBusiness
...
{
  public class UMServicesBusiness : BaseBusiness.BaseBusiness<UMServices>
  {
    public UMServicesBusiness()
    {
    }

    public UMServicesBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
