...
// Type: Akhbar.DBBusiness.LinkedNewBusiness
...
{
  public class LinkedNewBusiness : BaseBusiness.BaseBusiness<LinkedNew>
  {
    public LinkedNewBusiness()
    {
    }

    public LinkedNewBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
