...
// Type: Akhbar.DBBusiness.TempDeskShiftBusiness
...
{
  public class TempDeskShiftBusiness : BaseBusiness.BaseBusiness<TempDeskShift>
  {
    public TempDeskShiftBusiness()
    {
    }

    public TempDeskShiftBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
