...
// Type: Akhbar.DBBusiness.PollsOptionBusiness
...
{
  public class PollsOptionBusiness : BaseBusiness.BaseBusiness<PollsOption>
  {
    public PollsOptionBusiness()
    {
    }

    public PollsOptionBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
