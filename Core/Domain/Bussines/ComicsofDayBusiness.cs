...
// Type: Akhbar.DBBusiness.ComicsofDayBusiness
...
{
  public class ComicsofDayBusiness : BaseBusiness.BaseBusiness<ComicsofDay>
  {
    public ComicsofDayBusiness()
    {
    }

    public ComicsofDayBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
