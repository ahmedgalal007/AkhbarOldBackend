...
// Type: Akhbar.DBBusiness.PictureofDayBusiness
...
{
  public class PictureofDayBusiness : BaseBusiness.BaseBusiness<PictureofDay>
  {
    public PictureofDayBusiness()
    {
    }

    public PictureofDayBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
