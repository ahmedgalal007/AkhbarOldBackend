...
// Type: Akhbar.DBBusiness.NewsPollBusiness
...
{
  public class NewsPollBusiness : BaseBusiness.BaseBusiness<NewsPoll>
  {
    public NewsPollBusiness()
    {
    }

    public NewsPollBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
