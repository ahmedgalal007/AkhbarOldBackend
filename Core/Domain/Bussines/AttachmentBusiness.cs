...
// Type: Akhbar.DBBusiness.AttachmentBusiness
...
{
  public class AttachmentBusiness : BaseBusiness.BaseBusiness<Attachment>
  {
    public AttachmentBusiness()
    {
    }

    public AttachmentBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
