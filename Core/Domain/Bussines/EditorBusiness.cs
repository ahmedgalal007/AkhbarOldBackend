...
// Type: Akhbar.DBBusiness.EditorBusiness
...
{
  public class EditorBusiness : BaseBusiness.BaseBusiness<Editor>
  {
    public EditorBusiness()
    {
    }

    public EditorBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
