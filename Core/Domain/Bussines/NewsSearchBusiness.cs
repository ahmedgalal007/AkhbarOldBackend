...
// Type: Akhbar.DBBusiness.NewsSearchBusiness
...
{
  public class NewsSearchBusiness : BaseBusiness.BaseBusiness<NewsSearch>
  {
    public NewsSearchBusiness()
    {
    }

    public NewsSearchBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
