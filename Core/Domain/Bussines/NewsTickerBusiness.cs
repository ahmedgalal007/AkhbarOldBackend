...
// Type: Akhbar.DBBusiness.NewsTickerBusiness
...
{
  public class NewsTickerBusiness : BaseBusiness.BaseBusiness<NewsTicker>
  {
    public NewsTickerBusiness()
    {
    }

    public NewsTickerBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
