...
// Type: Akhbar.DBBusiness.MainSectionBusiness
...
{
  public class MainSectionBusiness : BaseBusiness.BaseBusiness<MainSection>
  {
    public MainSectionBusiness()
    {
    }

    public MainSectionBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
