...
// Type: Akhbar.DBBusiness.HomeMostCommentedBusiness
...
{
  public class HomeMostCommentedBusiness : BaseBusiness.BaseBusiness<HomeMostCommented>
  {
    public HomeMostCommentedBusiness()
    {
    }

    public HomeMostCommentedBusiness(DbContext _DbContext)
      : base(_DbContext)
    {
    }
  }
