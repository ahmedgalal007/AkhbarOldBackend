...
{
	public class AkherSaaController : Controller
	{
		...
		public AkherSaaController()
		{
			
			if (int.TryParse(WebConfigurationManager.AppSettings["AkherSaaSectionID"],out SectionID1))
			{
				SectionID1 = int.Parse(WebConfigurationManager.AppSettings["AkherSaaSectionID"]);
			}
			string subSetions = WebConfigurationManager.AppSettings["AkherSaaSubSections"];
