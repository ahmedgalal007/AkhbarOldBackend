...
{
	public class AkhbarElyomController : Controller
	{
		...
		public AkhbarElyomController()
		{
			
			if (int.TryParse(WebConfigurationManager.AppSettings["AkhbarElyomSectionID"],out SectionID1))
			{
				SectionID1 = int.Parse(WebConfigurationManager.AppSettings["AkhbarElyomSectionID"]);
			}
			string subSetions = WebConfigurationManager.AppSettings["AkhbarElyomSubSections"];
