...
{
	public class AllwaaController : Controller
	{
		...
		public AllwaaController()
		{
			
			if (int.TryParse(WebConfigurationManager.AppSettings["AllwaaSectionID"],out SectionID1))
			{
				SectionID1 = int.Parse(WebConfigurationManager.AppSettings["AllwaaSectionID"]);
			}
			string subSetions = WebConfigurationManager.AppSettings["AllwaaSubSections"];
