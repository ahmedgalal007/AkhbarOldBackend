...
{
	public class RiadahController : Controller
	{
		...
		public RiadahController()
		{
			
			if (int.TryParse(WebConfigurationManager.AppSettings["RiadaSectionID"],out SectionID1))
			{
				SectionID1 = int.Parse(WebConfigurationManager.AppSettings["RiadaSectionID"]);
			}
			string subSetions = WebConfigurationManager.AppSettings["RiadaSubSections"];
