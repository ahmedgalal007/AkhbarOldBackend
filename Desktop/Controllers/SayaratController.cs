...
{
	public class SayaratController : Controller
	{
		...
		public SayaratController()
		{
			
			if (int.TryParse(WebConfigurationManager.AppSettings["SayaratSectionID"],out SectionID1))
			{
				SectionID1 = int.Parse(WebConfigurationManager.AppSettings["SayaratSectionID"]);
			}
			string subSetions = WebConfigurationManager.AppSettings["SayaratSubSections"];
