...
{
	public class AdabController : Controller
	{
		...
		public AdabController()
		{
			
			if (int.TryParse(WebConfigurationManager.AppSettings["AdabSectionID"],out SectionID1))
			{
				SectionID1 = int.Parse(WebConfigurationManager.AppSettings["AdabSectionID"]);
			}
			string subSetions = WebConfigurationManager.AppSettings["AdabSubSections"];
