...
namespace AkhbarElyoum.Controllers
{
	public class AkhbarController : Controller
	{
		...
		public AkhbarController()
		{
			
			if (int.TryParse(WebConfigurationManager.AppSettings["AkhbarSectionID"],out SectionID1))
			{
				SectionID1 = int.Parse(WebConfigurationManager.AppSettings["AkhbarSectionID"]);
			}
			string subSetions = WebConfigurationManager.AppSettings["AkhbarSubSections"];
