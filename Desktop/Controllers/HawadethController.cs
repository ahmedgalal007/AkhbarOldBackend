...
{
	public class HawadethController : Controller
	{
		...
		public HawadethController()
		{
			
			if (int.TryParse(WebConfigurationManager.AppSettings["HawadethSectionID"],out SectionID1))
			{
				SectionID1 = int.Parse(WebConfigurationManager.AppSettings["HawadethSectionID"]);
			}
			string subSetions = WebConfigurationManager.AppSettings["HawadethSubSections"];
