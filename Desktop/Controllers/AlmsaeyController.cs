...
{
	public class AlmsaeyController : Controller
	{
		...
		public AlmsaeyController()
		{
			
			if (int.TryParse(WebConfigurationManager.AppSettings["AlmsaeySectionID"],out SectionID1))
			{
				SectionID1 = int.Parse(WebConfigurationManager.AppSettings["AlmsaeySectionID"]);
			}
			string subSetions = WebConfigurationManager.AppSettings["AlmsaeySubSections"];
