...
{
	public class KetabElyomController : Controller
	{
		...
		public KetabElyomController()
		{
			
			if (int.TryParse(WebConfigurationManager.AppSettings["KetabElyomSectionID"],out SectionID1))
			{
				SectionID1 = int.Parse(WebConfigurationManager.AppSettings["KetabElyomSectionID"]);
			}
			string subSetions = WebConfigurationManager.AppSettings["KetabElyomSubSections"];
