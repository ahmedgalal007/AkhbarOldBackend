...
{
	public class NogoomController : Controller
	{
		...
		public NogoomController()
		{
			
			if (int.TryParse(WebConfigurationManager.AppSettings["NogoomSectionID"],out SectionID1))
			{
				SectionID1 = int.Parse(WebConfigurationManager.AppSettings["NogoomSectionID"]);
			}
			string subSetions = WebConfigurationManager.AppSettings["NogoomSubSections"];
